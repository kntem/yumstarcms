(function($){ 
    ...
    $.fn.tablePagination = function(settings) {
        var defaults = {  
            firstArrow : (new Image()).src=site_url+"img/first.gif",  
            prevArrow : (new Image()).src=site_url+"img/prev.gif",
            lastArrow : (new Image()).src=site_url+"img/last.gif",
            nextArrow : (new Image()).src=site_url+"img/next.gif",
            rowsPerPage : 5,
            currPage : 1,
        ...
        return this.each(function() {
            ...
            function createPaginationElements() {
                var htmlBuffer = [];
                htmlBuffer.push("<div id='tablePagination' class='pagination_outer pagination pagination-right pagination-mini'>");
                htmlBuffer.push("<span id='tablePagination_perPage'>");
                htmlBuffer.push("<select id='tablePagination_rowsPerPage' class='per_page span2'><option value='5'>5</option></select>");
                htmlBuffer.push("<span class='per_page'>per page</span>");
                htmlBuffer.push("</span>");
                htmlBuffer.push("<ul id='tablePagination_paginater'>");
                htmlBuffer.push("<li><a href='javascript:void(0)'><img id='tablePagination_firstPage' src='"+defaults.firstArrow+"'></a></li>");
                htmlBuffer.push("<li><a href='javascript:void(0)'><img id='tablePagination_prevPage' class='aero_img65' src='"+defaults.prevArrow+"'></a></li>");
                htmlBuffer.push("<li><a href='javascript:void(0)'>Page</a></li>");
                htmlBuffer.push("<li><a href='javascript:void(0)' style='border: none;border-right: 1px solid #ddd;'><input id='tablePagination_currPage' type='input' value='"+currPageNumber+"' class='input-mini'></a></li>");
                htmlBuffer.push("<li> <a href='javascript:void(0)'>of</a></li><li><a href='javascript:void(0)'><span id='tablePagination_totalPages'>"+totalPages+"</span></a></li>");
                htmlBuffer.push("<li><a href='javascript:void(0)'><img id='tablePagination_nextPage' src='"+defaults.nextArrow+"'></a></li>");
                htmlBuffer.push("<li><a href='javascript:void(0)'><img id='tablePagination_lastPage' src='"+defaults.lastArrow+"'></a></li>");
                htmlBuffer.push("</li>");
                htmlBuffer.push("</ul></div>");
