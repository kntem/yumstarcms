                    ...
                    $.ajax({//fetch the article via ajax            
                        ...
                        success: function(html) {
                            ...
                            if (response.is_deleted == 1) {
                               ...
                               if(rowCount == 1){                                
                              $('#orderItem_list > tbody:last').append('<tr><td colspan="8" class="fc-header-center">No Data found</td></tr>');
                               }
...
//                                 echo $time = date('H:i:s' , strtotime($date));
                               ...
                               <!--<td><span class="label label-success">Active</span></td>-->
                                ...
                                <!--</td>-->
                                <td><?php echo $orderItem['Order']['total_amount']?></td>
                            </tr>
                            <?php
                        }
                    }else {
                    ?>
                    <tr> <td colspan="8" style="text-align:center">No Record Found</td></tr><?php } ?>
                </tbody>
            </table>
        </div>
    </div>
